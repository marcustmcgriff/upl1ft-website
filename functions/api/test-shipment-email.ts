  ...
  <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
    ...
    <div style="background: #111; padding: 24px; margin-bottom: 24px;">
      ...
      <div style="padding: 8px 0; border-bottom: 1px solid #222;">
        ...
        <a href="${carrierTrackingUrl}" style="color: #C8A24A; font-family: monospace; font-size: 14px; text-decoration: none; word-break: break-all;">${escapeHtml(trackingNumber)}</a>
      </div>
      <div style="padding: 8px 0; border-bottom: 1px solid #222;">
      ...
      <div style="padding: 8px 0;">
        ...
        <span style="color: #C8A24A; font-size: 14px; font-weight: bold;">${formatDate(estimatedDelivery)}</span>
      </div>
    </div>
    ...
    <div style="text-align: center; margin-bottom: 40px;">
      <a href="${siteUrl}/shop" style="color: #C8A24A; text-decoration: none; font-size: 14px; letter-spacing: 1px;">Continue Shopping &rarr;</a>
    </div>
